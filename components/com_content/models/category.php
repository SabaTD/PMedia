...
class ContentModelCategory extends JModel
{
	...
	function _loadCategory()
	{
		if ( empty( $this->_category ) )
		{
			...
			SELECT c.*, s.id as sectionid, s.title as sectiontitle,' .
	...
	function _buildQuery( $state = 1 )
	{
		...
		$query = '#Content Category ' . PHP_EOL
						. 'SELECT cc.title AS category, a.id, a.title, a.alias, a.title_alias, a.introtext, a.fulltext, a.sectionid, a.state, a.catid, a.created, a.created_by, a.created_by_alias, a.modified, a.modified_by,' .
