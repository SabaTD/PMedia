...
<div class="other_news_item1">
        ...
        ?>
       <div class="blog_title<?php echo $this->params->get('pageclass_sfx') ?>"> <?php if (!empty($this->item->readmore_link))
        {
            ?>		
    ...
    <?php if (!empty($this->item->readmore_link))
    {
        ?>
        <div class="readmore_articlei">
                <a class="readoni" href="<?php echo $this->item->readmore_link; ?>" class="readon_a">
